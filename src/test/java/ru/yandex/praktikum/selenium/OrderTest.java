...
public class OrderTest extends BaseTest {
    ...
    public OrderTest(String name, String lastName, String address, String phoneNumber, String date) {
        this.name = name;
    ...
    public static Object[][] createOrder() {
        return new Object[][] {
                {"Валентин", "Серов", "Лаврушинский пер., 10", "79918651911", "15.07.2023"},
                {"Казимир", "Малевич", "Крымский вал, 10", "+79918791935", "19.07.2023"},
        };
    }
    @Test
    public void checkOrderingScooterByTopButton() {
    ...
    @Test
    public void checkOrderingScooterByBottomButton() {
